        ...
        <CardItemGroup orientation="horizontal">
          <InputGroup>
            <Input
              ...
              autoCorrect="off"
              autoCapitalize="off"
              className="rounded-md border border-slate-500 dark:border-slate-900 focus:border-slate-500 dark:focus:border-slate-900 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:focus:ring-slate-900"
            />
          </InputGroup>
  ...
  (
    ...
    return (
      <Popover open={isOpen} onOpenChange={handleOnOpenChange}>
        ...
        <PopoverContent
          className="bg-slate-200 dark:bg-slate-800 border-slate-200 dark:border-slate-800 rounded-md p-2 border"
        >
          <LinkMain
            url={url}
            setUrl={setUrl}
